...
static void MX_GPIO_Init(void)
{
    ...
    /* Configure GPIO pins for GPIOC: PC13, PC14, PC15 */
    ...
    /* Configure GPIO pin for GPIOA: PA0 */
    GPIO_InitStruct.Pin = GPIO_PIN_0;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    /* Set all LEDs to OFF at initialization */
...
void green_led(void *argument)
{
  ...
  /* Infinite loop */
	for (;;)
	  {
	    HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13, GPIO_PIN_SET); // Blue LED ON (PC13)

	    for (int i = 0; i < 80; i++) {
	      HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_14); // Toggle Green LED (PC14)
	      HAL_Delay(50);
	    }
...
void red_led(void *argument)
{
  ...
  /* Infinite loop */
	for (;;)
	  {
	    HAL_GPIO_WritePin(GPIOA, GPIO_PIN_0, GPIO_PIN_SET); // Orange LED ON (PA0)

	    for (int i = 0; i < 10; i++) {
	      HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_15); // Toggle Red LED (PC15)
	      HAL_Delay(50);
	    }
